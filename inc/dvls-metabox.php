...
<div class="dvls-metabox-wrap">
    ...
    <div class="dvls-col-right dvls_maps_control">
        <table>
            <tr>
                <td colspan="2">
                    <label for="dvls_maps_address"><?php _e('Place Name','devvn-localstore')?></label>
                    <input name="dvls[maps_address]" id="dvls_maps_address" class="controls" autocomplete="off" onkeypress="return event.keyCode != 13;" placeholder="<?php _e('Type a place name to find','devvn-localstore')?>"/>
                </td>
            </tr>
            <tr>
                <td>
                    <label for="dvls_maps_lat"><?php _e('Latitude','devvn-localstore')?></label>
                    <input name="dvls[maps_lat]" id="dvls_maps_lat" value="<?php echo ($dvls_data['maps_lat'])?$dvls_data['maps_lat']:$dvls_settings['lat_default']?>" placeholder="<?php _e('lat coordinate','devvn-localstore')?>"/>
                </td>
                <td>
                    <label for="dvls_maps_lng"><?php _e('Longitude','devvn-localstore')?></label>
                    <input name="dvls[maps_lng]" id="dvls_maps_lng" value="<?php echo ($dvls_data['maps_lng']) ? $dvls_data['maps_lng']: $dvls_settings['lng_default']?>" placeholder="<?php _e('long coordinate','devvn-localstore')?>"/>
                </td>
            </tr>
            <tr>
                <td colspan="2">
                    ...
                    <small><i class="dvls-icon dashicons-editor-help"></i> <?php _e('Click to select place','devvn-localstore')?></small>
                </td>
            </tr>
        </table>
    </div>
